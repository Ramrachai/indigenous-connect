...
export default function HomePage() {
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        "Assemble your team and embark on collaborative projects—private groups provide an excellent foundation for collective achievement.",
    },
    {
    ...
    <div className="min-h-screen ">
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2">
                <div className="p-8">
                  ...
                  <p className="text-muted-foreground mb-4">
                    Indigenous Connect is a platform dedicated to uniting the indigenous community of Bangladesh. Our mission is to provide a space
                    for sharing, learning, and preserving our rich cultural heritage while addressing the unique challenges and opportunities faced by
                    our community.
                  </p>
                  <Button asChild>
              ...
              {features.map((feature, index) => (
                <Card
                  ...
                  className={`cursor-pointer transition-all duration-300 ${
                    activeFeature === index ? "border-stone-400 shadow-lg" : "hover:border-stone-400"
                  }`}
        ...
        <section id="contact" className="text-center py-20">
          ...
          <Button size="lg" asChild className="rounded-full">
            <a href="mailto:ramrachaim@gmail.com">
...
function MediaCard({ icon, title, description }: { icon: React.ReactNode; title: string; description: string }) {
  return (
    <Card className="text-center hover:shadow-lg transition-shadow duration-300">
      <CardHeader>
        <div className="mx-auto bg-emerald-100 rounded-full p-3 mb-4">{icon}</div>
